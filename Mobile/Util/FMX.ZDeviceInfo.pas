...
const
  TZNetworkConnectionTypeString: array [TZNetworkConnectionType] of string = ('None', 'Unknown', 'WIFI', 'Mobile Data', 'Ethernet');
...
begin
{$WARNINGS OFF}
  Result := (((FTimeZone.Local.UtcOffset.Hours * 60) + FTimeZone.Local.UtcOffset.Minutes) * 60) + FTimeZone.Local.UtcOffset.Seconds;
{$WARNINGS ON}
end;
