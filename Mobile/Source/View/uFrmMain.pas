...
begin
  ...
  TModelParametros.new.RetornaLogo(Image2);
...
begin
  ...
  begin
    TModelUsuarios.new.Usuario(edtusuario.Text).Senha(edtSenha.Text).ValidaLogin;
...
begin
  ...
  begin
    ...
    if TabPedidos = 2 then
    begin
      TabControl.TabIndex := 0;
    end
    else
      if TabPedidos = 3 then
      begin
        TabControl.TabIndex := 2;
      end
      else
        if TabPedidos = 4 then
        begin
          TabControl.TabIndex := 2;
        end
        else
          if TabPedidos = 5 then
          begin
            TabControl.TabIndex := 6;
          end
          else
            if TabPedidos = 6 then
            begin
              TabControl.TabIndex := 2;
            end;
end;
