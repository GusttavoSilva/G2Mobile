...
{$IFDEF ANDROID}
  SInputQueryAndroidOverloads = 'On Android platform, only overloads with TInputCloseBoxProc or TInputCloseBoxEvent ' + 'are supported';
{$ENDIF}
  ...
  SInvalidPlatformStyle = 'No platform style found for the current platform';
  // happens when there are platform styles, just not the right ones
...
resourcestring
  ...
  SAppAnalyticsDefaultPrivacyMessage = 'Privacy Notice:' + sLinebreak + sLinebreak +
    ...
    'your usage can be tracked back to you.' + sLinebreak + sLinebreak + 'Please click Yes to help us to improve this software. Thank you.';
  ...
  SPermissionCannotChangeDataInAddressBook =
    'Writing permission [WRITE_CONTACTS] has not been granted. You will not be able to make changes with AddressBook';
  SPermissionCannotGetDataFromAddressBook =
