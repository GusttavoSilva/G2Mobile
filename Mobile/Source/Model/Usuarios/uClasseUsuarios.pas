...
uses FMX.ListView, uDmDados, uRESTDWPoolerDB,
  ...
  Datasnap.DBClient, FireDAC.Comp.DataSet, Data.DB, uInterfaceUsuarios,
  FMX.Objects, Form_Mensagem, uFrmUtilFormate;

type



  TUsuarios = class(TInterfacedObject, iModelUsuarios)
  private
    FUsuario: String;
    FSenha:   String;
  public
...
class function TUsuarios.new: iModelUsuarios;
begin
  result := self.create;
end;
...
function TUsuarios.Senha(value: String): iModelUsuarios;
begin
  result := self;
  FSenha := value;
end;

function TUsuarios.Usuario(value: String): iModelUsuarios;
begin
  result   := self;
  FUsuario := value;
end;

function TUsuarios.LimpaTabelaUser: iModelUsuarios;
var
  qry: TFDQuery;
begin
  result := self;
...
function TUsuarios.BuscaUserServidor(ADataSet: TFDMemTable): iModelUsuarios;
var
...
function TUsuarios.PopulaUserSqLite(ADataSet: TFDMemTable): iModelUsuarios;
var
  i:   Integer;
  qry: TFDQuery;
begin
...
function TUsuarios.ValidaLogin: iModelUsuarios;
var
  qry: TFDQuery;
begin
  result := self;
