...
type
  ...
  TTitulosCliente = class(TInterfacedObject, iModelTitulosCliente)
  private
    FQry: TFDQuery;
...
class function TTitulosCliente.new: iModelTitulosCliente;
begin
  result := self.create;
end;

constructor TTitulosCliente.create;
begin
...
destructor TTitulosCliente.destroy;
begin
  FreeAndNil(FQry);
...
function TTitulosCliente.DeleteTitulos: iModelTitulosCliente;
begin
  result := self;
  FQry.ExecSQL(CONST_DELETETITULOS);
end;

function TTitulosCliente.DeleteItensTitulo: iModelTitulosCliente;
begin
  result := self;
  FQry.ExecSQL(CONST_DELETEITENSTITULO);
end;

function TTitulosCliente.BuscaTitulosServidor(DataSet: TFDMemTable): iModelTitulosCliente;
begin
  result := self;
...
function TTitulosCliente.CodCliente(value: Integer): iModelTitulosCliente;
begin
  result := self;
  FCodCliente := value;
end;

function TTitulosCliente.CodPedcar(value: Integer): iModelTitulosCliente;
begin
  result := self;
  FCodPedcar := value;
end;

function TTitulosCliente.CodVend(value: Integer): iModelTitulosCliente;
begin
  result := self;
  FCodVend := value;
end;

function TTitulosCliente.GravaTitulosSqlite(DataSet: TFDMemTable): iModelTitulosCliente;
var
  I: Integer;
begin
  result := self;
...
function TTitulosCliente.BuscaItensTituloServidor(DataSet: TFDMemTable): iModelTitulosCliente;
begin
  result := self;
...
function TTitulosCliente.GravaItensTituloSqlite(DataSet: TFDMemTable): iModelTitulosCliente;
var
  I: Integer;
begin
  result := self;
...
function TTitulosCliente.PopulaListView(value: TListView; aberta, vencida: Timage): iModelTitulosCliente;
var
  x: Integer;
  item: TListViewItem;
  txt: TListItemText;
...
function TTitulosCliente.PopulaItemTituloStringGrid(Grid: TStringGrid): iModelTitulosCliente;
var
  I: Integer;
begin
  result := self;
