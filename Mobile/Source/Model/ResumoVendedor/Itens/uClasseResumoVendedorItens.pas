unit uClasseResumoVendedorItens;

interface

uses uInterfaceResumoVendedorItens, FMX.ListView, uDmDados, uRESTDWPoolerDB,
...
type
  ...
  TResumoVendedorItens = class(TInterfacedObject, iModelResumoVendedorItens)
  private
    FNomeProd: String;
    FPesoTot:  Double;
    FVlrTot:   Double;
...
constructor TResumoVendedorItens.create;
begin

end;

destructor TResumoVendedorItens.destroy;
begin

  inherited;
end;

class function TResumoVendedorItens.new: iModelResumoVendedorItens;
begin
  result := self.create;
end;

function TResumoVendedorItens.NomeProd(value: String): iModelResumoVendedorItens;
begin
  result    := self;
  FNomeProd := value;
end;

function TResumoVendedorItens.QntReal(value: Integer): iModelResumoVendedorItens;
begin
  result   := self;
  FQntReal := value;
end;

function TResumoVendedorItens.VlrTot(value: Double): iModelResumoVendedorItens;
begin
  result  := self;
  FVlrTot := value;
end;

function TResumoVendedorItens.PesoTot(value: Double): iModelResumoVendedorItens;
begin
  result   := self;
  FPesoTot := value;
end;

function TResumoVendedorItens.LimpaTabelas: iModelResumoVendedorItens;
var
  qry: TFDQuery;
begin
  result := self;
...
function TResumoVendedorItens.PopulaListView(value: TListView; AList: TStringList): iModelResumoVendedorItens;
var
  x:    Integer;
  qry:  TFDQuery;
  item: TListViewItem;
...
function TResumoVendedorItens.PopulaProdVendidoSqLite(ADataSet: TFDMemTable): iModelResumoVendedorItens;
var
  i:   Integer;
  qry: TFDQuery;
begin
...
function TResumoVendedorItens.BuscaProdVendidosServidor(dt_ini, dt_fim: tDatetime; vend: Integer; ADataSet: TFDMemTable)
