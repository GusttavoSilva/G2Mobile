...
uses FMX.ListView, uDmDados, uRESTDWPoolerDB,
  ...
  FMX.Objects, uInterfaceFormaPagamento, FMX.Graphics;
...
const
  ...
  CONST_POPULAFORMAPAGAMENTOSQLITE = ' INSERT INTO FORMAPAGTO ( COD_DOC, DESCRICAO, COD_FORMA) VALUES ( :COD_DOC, :DESCRICAO, :COD_FORMA)';
  ...
  CONST_POPULAPAGAMENTOPESSOASQlITE = ' INSERT INTO PESSOA_FPGTO ( COD_PESSOA, COD_FORMA) VALUES ( :COD_PESSOA, :COD_FORMA)';
...
type
  ...
  TFormaPagamento = class(TInterfacedObject, iModelFormaPagamento)
...
class function TFormaPagamento.new: iModelFormaPagamento;
begin
  result := self.create;
end;
...
function TFormaPagamento.LimpaTabelaFormaPagamento: iModelFormaPagamento;
begin
  result := self;
...
function TFormaPagamento.BuscaFormaPagamentoServidor(ADataSet: TFDMemTable): iModelFormaPagamento;
begin
  result := self;
...
function TFormaPagamento.PopulaFormaPagamentoSqLite(ADataSet: TFDMemTable): iModelFormaPagamento;
var
  i: integer;
begin
  result := self;
...
function TFormaPagamento.LimpaTabelaPagamentoPessoa: iModelFormaPagamento;
begin
  result := self;
...
function TFormaPagamento.BuscaPagamentoPessoaServidor(ADataSet: TFDMemTable): iModelFormaPagamento;
begin
  result := self;
...
function TFormaPagamento.PopulaPagamentoPessoaSqLite(ADataSet: TFDMemTable): iModelFormaPagamento;
var
  i: integer;
begin
  result := self;
...
function TFormaPagamento.BuscarFormaPagamento(value: integer): String;
begin
...
function TFormaPagamento.BuscaUltimaFormaDePagamentoCliente(value: integer): String;
begin
...
function TFormaPagamento.PopulaListView(Cod: integer; value: TListView; imageForma: Timage): iModelFormaPagamento;
var
  x:    integer;
  item: TListViewItem;
  txt:  TListItemText;
