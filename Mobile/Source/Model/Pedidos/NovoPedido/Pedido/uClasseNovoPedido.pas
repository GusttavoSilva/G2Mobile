...
type
  TNovoPedido = class(TInterfacedObject, iModelNovoPedido)
  private
    FQry: TFDQuery;
...
class function TNovoPedido.new: iModelNovoPedido;
begin
  result := self.create;
end;

constructor TNovoPedido.create;
begin
...
destructor TNovoPedido.destroy;
begin
  FreeAndNil(FQry);
  inherited;
end;

function TNovoPedido.PSituacao(value: integer): iModelNovoPedido;
begin
  result := self;
  FPSituacao := value;
end;

function TNovoPedido.Total(value: Double): iModelNovoPedido;
begin
  result := self;
  FTotal := value;
end;

function TNovoPedido.Emissao(value: Tdatetime): iModelNovoPedido;
begin
  result := self;
  FEmissao := value;
end;

function TNovoPedido.CodUser(value: integer): iModelNovoPedido;
begin
  result := self;
  FCodUser := value;
end;

function TNovoPedido.CodVendedor(value: integer): iModelNovoPedido;
begin
  result := self;
  FCodVendedor := value;
end;

function TNovoPedido.Comissao(value: integer): iModelNovoPedido;
begin
  result := self;
  FComissao := value;
end;

function TNovoPedido.Obs(value: String): iModelNovoPedido;
begin
  result := self;
  FObs := value;
end;

function TNovoPedido.Valor(value: Double): iModelNovoPedido;
begin
  result := self;
  FValor := value;
end;

function TNovoPedido.Acao(value: integer): iModelNovoPedido;
begin
  result := self;
  FAcao := value;
end;

function TNovoPedido.Chave(value: String): iModelNovoPedido;
begin
  result := self;
  FChave := value;
end;

function TNovoPedido.CodCamara(value: integer): iModelNovoPedido;
begin
  result := self;
  FCodCamara := value;
end;

function TNovoPedido.Desconto(value: Double): iModelNovoPedido;
begin
  result := self;
  FDesconto := value;
end;

function TNovoPedido.Latitude(value: String): iModelNovoPedido;
begin
  result := self;
  FLatitude := value;
end;

function TNovoPedido.Longitude(value: String): iModelNovoPedido;
begin
  result := self;
  FLongitude := value;
end;

function TNovoPedido.PDataIni(value: Tdatetime): iModelNovoPedido;
begin
  result := self;
  FPDataIni := value;
end;

function TNovoPedido.PDataFim(value: Tdatetime): iModelNovoPedido;
begin
  result := self;
  FPDataFim := value;
end;

function TNovoPedido.CodCliente(value: integer): iModelNovoPedido;
begin
  result := self;
  FCodCliente := value;
end;

function TNovoPedido.DataEmb(value: TDate): iModelNovoPedido;
begin
  result := self;
  FDataEmb := value;
end;

function TNovoPedido.FormaPagamento(value: integer): iModelNovoPedido;
begin
  result := self;
  FFormaPagamento := value;
end;

function TNovoPedido.Filter: iModelNovoPedido;
begin
  result := self;
...
function TNovoPedido.DeletePedido: iModelNovoPedido;
begin
  result := self;
...
function TNovoPedido.PopulaListPedidos(value: TListView; enviado, pendente, aprovado, reprovado: TImage)
  : iModelNovoPedido;
var
  x: integer;
  item: TListViewItem;
...
function TNovoPedido.InfoPedido(value: String; AList: TStringList): iModelNovoPedido;
var
  i: integer;
begin
  result := self;
...
function TNovoPedido.StatusPedido: iModelNovoPedido;
begin
  result := self;
...
function TNovoPedido.EditaReplicaPedido(AList: TStringList): iModelNovoPedido;
var
  i: integer;
begin
  result := self;
...
function TNovoPedido.ValidaAddProd: iModelNovoPedido;
begin
  result := self;
...
function TNovoPedido.InsertPedido: iModelNovoPedido;
begin
  result := self;
...
function TNovoPedido.VerificaPedido(Grid: TStringGrid): String;
